...
export const DoubleCheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
);
...
export const UploadCloudIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"></path><polyline points="12 12 12 21"></polyline><polyline points="16 16 12 12 8 16"></polyline></svg>
);
...
export const GoogleDriveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="m15.82 10.35-1.53 8.84-6.8-4.21 1.53-8.84 6.8 4.21z"/>
    <path d="M8.2 5.16 15 9.37l4.58-2.85L12.78 2 8.2 5.16z"/>
    <path d="M2.22 17.58 8.8 22l6.8-4.2-6.58-4.22-6.8 4z"/>
  </svg>
);
...
export const SoundWaveIcon: React.FC = () => (
    <div className="flex items-center justify-center space-x-1 w-12 h-6">
        <div className="w-1 bg-blue-500 animate-waving-line" style={{animationDelay: '0s', height: '100%'}}></div>
        <div className="w-1 bg-blue-400 animate-waving-line" style={{animationDelay: '0.1s', height: '75%'}}></div>
        <div className="w-1 bg-blue-500 animate-waving-line" style={{animationDelay: '0.2s', height: '100%'}}></div>
        <div className="w-1 bg-blue-400 animate-waving-line" style={{animationDelay: '0.3s', height: '50%'}}></div>
        <div className="w-1 bg-blue-500 animate-waving-line" style={{animationDelay: '0.4s', height: '85%'}}></div>
    </div>
);
...
export const TelegramIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 2 11 13H2l2.65 9.35A1 1 0 0 0 5.6 23l1.8-6.85L22 2z"></path><path d="m22 2-7.5 11-4.5 4.5"></path><path d="m11 13 1.5 5.5"></path></svg>
);
